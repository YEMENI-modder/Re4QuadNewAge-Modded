...
namespace Re4QuadExtremeEditor.src.Class.Files
{
    ...
    public abstract class BaseGroup
    {
        ...
        {
            EndianBitConverter.WriteTo(value, GetInternalLine(ID), FromPosition, GetEndianness());
        }
        ...
        {
            byte[] src = GetInternalLine(ID);
            byte[] result = new byte[Count];
            Buffer.BlockCopy(src, FromPosition, result, 0, Count);
            return result;
        }
