...
namespace Re4QuadExtremeEditor.src.Class.Files
{
    public class File_EFFBLOB_Group
    {
        ...
        public class EffTable9 : BaseGroup
        {
            ...
            {
                EndianBitConverter.WriteTo(value, Table9Lines[ID].Line, 0x00, Endian);
            }
            ...
            {
                EndianBitConverter.WriteTo(value, Table9Lines[ID].Line, 0x04, Endian);
            }
            ...
            {
                EndianBitConverter.WriteTo(value, Table9Lines[ID].Line, 0x08, Endian);
            }
        ...
        public class EffTableEffectGroup : BaseGroup
        {
            ...
            private void SetPositionX_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, Table_Effect_Group[ID].Line, 0x0C -2, Endian);
            }
            ...
            private void SetPositionY_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, Table_Effect_Group[ID].Line, 0x10 -2, Endian);
            }
            ...
            private void SetPositionZ_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, Table_Effect_Group[ID].Line, 0x14 -2, Endian);
            }
            ...
            {
                EndianBitConverter.WriteTo(value, Table_Effect_Group[ID].Line, 0x18 -2, Endian);
            }
            ...
            {
                EndianBitConverter.WriteTo(value, Table_Effect_Group[ID].Line, 0x1C -2, Endian);
            }
            ...
            {
                EndianBitConverter.WriteTo(value, Table_Effect_Group[ID].Line, 0x20 -2, Endian);
            }
        ...
        public class EffTableEffectEntry : BaseGroup
        {
            ...
            private void SetPositionX_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, EffectEntry[ID].Line, 0x0C, Endian);
            }
            ...
            private void SetPositionY_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, EffectEntry[ID].Line, 0x10, Endian);
            }
            ...
            private void SetPositionZ_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, EffectEntry[ID].Line, 0x14, Endian);
            }
            ...
            private void SetAngleX_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, EffectEntry[ID].Line, 0x58, Endian);
            }
            ...
            private void SetAngleY_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, EffectEntry[ID].Line, 0x5C, Endian);
            }
            ...
            private void SetAngleZ_Hex(ushort ID, uint value)
            {
                EndianBitConverter.WriteTo(value, EffectEntry[ID].Line, 0x60, Endian);
            }
