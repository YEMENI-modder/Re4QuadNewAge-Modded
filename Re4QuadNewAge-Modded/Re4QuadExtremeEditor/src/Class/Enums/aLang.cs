...
namespace Re4QuadExtremeEditor.src.Class.Enums
{
    ...
    {      
        ...
        Enemy_AssociatedITAItemCategory,
        Enemy_AssociatedITAItemDisplayName,
        Enemy_AssociatedITAItemDescription,
        Enemy_AssociatedITARefInteractionTypeDisplayName,
        Enemy_AssociatedITARefInteractionIndexDisplayName,
        Enemy_AssociatedITAItemNumberDisplayName,
        Enemy_AssociatedITASecundIndexDisplayName,
        Enemy_AssociatedITAItemAuraTypeDisplayName,
        ...
        AVL_NumberOfAev_DisplayName,
        AVL_NumberOfAev_Description,

        AVL_KeyId_DisplayName,
        AVL_KeyId_Description,

        AVL_LockMessage_DisplayName,
        AVL_LockMessage_Description,

        AVL_LockSound_DisplayName,
        AVL_LockSound_Description,

        AVL_LockCameraEnabled_DisplayName,
        AVL_LockCameraEnabled_Description,

        AVL_LockCamera_DisplayName,
        AVL_LockCamera_Description,

        AVL_UnlockMessage_DisplayName,
        AVL_UnlockMessage_Description,

        AVL_UnlockSound_DisplayName,
        AVL_UnlockSound_Description,

        //RTP Property
        NewAge_RTP_Category,
        NewAge_RTPLinks_Category,

        RTP_PosX_DisplayName,
        RTP_PosY_DisplayName,
        RTP_PosZ_DisplayName,
        RTP_Pos_Description,

        RTP_DistanceTableIndex_DisplayName,
        RTP_DistanceTableIndex_Description,

        RTP_ConnectionCount_DisplayName,
        RTP_ConnectionCount_Description,

        RTP_ConnectTo_DisplayName,
        RTP_ConnectTo_Description,

        RTP_DisconnectFrom_DisplayName,
        RTP_DisconnectFrom_Description,

        RTP_LinksSummary_DisplayName,
        RTP_LinksSummary_Description,

        //CAM Property
        NewAge_CAM_Category,
        NewAge_CAMKeys_Category,
        NewAge_CAMZone_Category,
        NewAge_CAMZoneLink_Category,
        NewAge_CAMPoints_Category,

        CAM_CamId_DisplayName,
        CAM_CamId_Description,

        CAM_Type_DisplayName,
        CAM_Type_Description,

        CAM_Flags_DisplayName,
        CAM_Flags_Description,

        CAM_FlagNormal_DisplayName,
        CAM_FlagBattle_DisplayName,
        CAM_FlagEvent_DisplayName,
        CAM_FlagDoor_DisplayName,
        CAM_FlagOnce_DisplayName,
        CAM_FlagAhead_DisplayName,
        CAM_FlagDirect_DisplayName,
        CAM_FlagDislgt_DisplayName,
        CAM_FlagBit_Description,

        CAM_Distance_DisplayName,
        CAM_Distance_Description,

        CAM_Unk021_DisplayName,
        CAM_Unk021_Description,

        CAM_Unk025_DisplayName,
        CAM_Unk025_Description,

        CAM_Unk027_DisplayName,
        CAM_Unk027_Description,

        CAM_Raw12_DisplayName,
        CAM_Raw12_Description,

        CAM_KeyframeCount_DisplayName,
        CAM_KeyframeCount_Description,

        CAM_SelectedKeyframe_DisplayName,
        CAM_SelectedKeyframe_Description,

        CAM_PosX_DisplayName,
        CAM_PosY_DisplayName,
        CAM_PosZ_DisplayName,
        CAM_Pos_Description,

        CAM_TargetX_DisplayName,
        CAM_TargetY_DisplayName,
        CAM_TargetZ_DisplayName,
        CAM_Target_Description,

        CAM_Zoom_DisplayName,
        CAM_Zoom_Description,

        CAM_Fov_DisplayName,
        CAM_Fov_Description,

        CAM_TimeFrame_DisplayName,
        CAM_TimeFrame_Description,

        ZN_LinkLine_DisplayName,
        ZN_LinkLine_Description,

        ZN_TriggerType_DisplayName,
        ZN_TriggerType_Description,

        ZN_LinkedCamera_DisplayName,
        ZN_LinkedCamera_Description,

        ZN_LinkUnk012_DisplayName,
        ZN_LinkUnk012_Description,

        ZN_Unk015_DisplayName,
        ZN_Unk015_Description,

        ZN_Unk016_DisplayName,
        ZN_Unk016_Description,

        ZN_Unk017_DisplayName,
        ZN_Unk017_Description,

        ZN_EntryNumber_DisplayName,
        ZN_EntryNumber_Description,

        ZN_Height_DisplayName,
        ZN_Height_Description,

        ZN_Bottom_DisplayName,
        ZN_Bottom_Description,

        ZN_CamTypeTz_DisplayName,
        ZN_CamTypeTz_Description,

        ZN_Subtype_DisplayName,
        ZN_Subtype_Description,

        ZN_Unk051_DisplayName,
        ZN_Unk051_Description,

        ZN_PointCount_DisplayName,
        ZN_PointCount_Description,

        ZN_SelectedPoint_DisplayName,
        ZN_SelectedPoint_Description,

        ZN_PointX_DisplayName,
        ZN_PointY_DisplayName,
        ZN_PointZ_DisplayName,
        ZN_Point_Description,
        ...
        SMX_UseSMXID_Byte_DisplayName,
        SMX_UseSMXID_Byte_Description,

        SMX_Mode_Byte_DisplayName,
        SMX_Mode_Byte_Description,

        SMX_OpacityHierarchy_Byte_DisplayName,
        SMX_OpacityHierarchy_Byte_Description,

        SMX_FaceCulling_Byte_DisplayName,
        SMX_FaceCulling_Byte_Description,

        SMX_LightSwitch_Uint32_DisplayName,
        SMX_LightSwitch_Uint32_Description,

        SMX_AlphaHierarchy_Byte_DisplayName,
        SMX_AlphaHierarchy_Byte_Description,

        SMX_ColorRGB_DisplayName,
        SMX_ColorRGB_Description,

        SMX_ColorAlpha_Byte_DisplayName,
        SMX_ColorAlpha_Byte_Description,

        SMX_RotationSpeed_X_Float_DisplayName,
        SMX_RotationSpeed_X_Float_Description,

        SMX_RotationSpeed_Y_Float_DisplayName,
        SMX_RotationSpeed_Y_Float_Description,

        SMX_RotationSpeed_Z_Float_DisplayName,
        SMX_RotationSpeed_Z_Float_Description,

        SMX_Swing0_Float_DisplayName,
        SMX_Swing0_Float_Description,

        SMX_Swing1_Float_DisplayName,
        SMX_Swing1_Float_Description,

        SMX_Swing2_Float_DisplayName,
        SMX_Swing2_Float_Description,

        SMX_Swing3_Float_DisplayName,
        SMX_Swing3_Float_Description,

        SMX_Swing4_Float_DisplayName,
        SMX_Swing4_Float_Description,

        SMX_Swing5_Float_DisplayName,
        SMX_Swing5_Float_Description,

        SMX_Swing6_Float_DisplayName,
        SMX_Swing6_Float_Description,

        SMX_Swing7_Float_DisplayName,
        SMX_Swing7_Float_Description,

        SMX_Swing8_Float_DisplayName,
        SMX_Swing8_Float_Description,

        SMX_Swing9_Float_DisplayName,
        SMX_Swing9_Float_Description,

        SMX_SwingA_Float_DisplayName,
        SMX_SwingA_Float_Description,

        SMX_SwingB_Float_DisplayName,
        SMX_SwingB_Float_Description,

        SMX_SwingC_Float_DisplayName,
        SMX_SwingC_Float_Description,

        SMX_UnknownU84_Uint32_DisplayName,
        SMX_UnknownU84_Uint32_Description,

        SMX_TextureMovement_X_Float_DisplayName,
        SMX_TextureMovement_X_Float_Description,

        SMX_TextureMovement_Y_Float_DisplayName,
        SMX_TextureMovement_Y_Float_Description,

        SMX_SpecularColor_Uint32_DisplayName,
        SMX_SpecularColor_Uint32_Description,

        SMX_Line_ByteArray_DisplayName,
        SMX_Line_ByteArray_Description,
