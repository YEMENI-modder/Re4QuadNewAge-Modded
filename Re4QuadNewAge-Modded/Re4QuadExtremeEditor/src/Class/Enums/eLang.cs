...
namespace Re4QuadExtremeEditor.src.Class.Enums
{
    public enum eLang : uint
    {
        ...
        Wizard_WelcomeTitle,
        Wizard_WelcomeSub,
        Wizard_CreditsRights,
        Wizard_CreditsEdition,
        Wizard_SectionLanguage,
        Wizard_SectionAppearance,
        Wizard_SkyColor,
        Wizard_CustomPreset,
        Wizard_CustomColorTitle,
        Wizard_OK,
        Wizard_Cancel,
        Wizard_ThemeSwitch,
        Wizard_SectionMouse,
        ...
        Wizard_AutoDetect,
        Wizard_DetectFound,
        Wizard_DetectNotFound,
        Wizard_ToolsTitle,
        Wizard_ToolsSub,
        Wizard_ForceReloadSwitch,
        Wizard_ForceReloadHint,
