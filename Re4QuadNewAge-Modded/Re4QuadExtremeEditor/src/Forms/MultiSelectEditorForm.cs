...
namespace Re4QuadExtremeEditor.src.Forms
{
    public partial class MultiSelectEditorForm : Form
    {
        ...
        public MultiSelectEditorForm(ref MultiSelectObjInfoToProperty objM)
        {
            ...
            var Object3D_AVL = Selecteds.FindAll(o => o.Parent != null && o.Parent is TreeNodeGroup g && g.Group == GroupType.AVL).Cast<Object3D>();
            ...
            var Object3D_CAM = Selecteds.FindAll(o => o.Parent != null && o.Parent is TreeNodeGroup g && g.Group == GroupType.CAM).Cast<Object3D>();
            var Object3D_CAM_ZONE = Selecteds.FindAll(o => o.Parent != null && o.Parent is TreeNodeGroup g && g.Group == GroupType.CAM_ZONE).Cast<Object3D>();
            var Object3D_RTP = Selecteds.FindAll(o => o.Parent != null && o.Parent is TreeNodeGroup g && g.Group == GroupType.RTP).Cast<Object3D>();
            ...
            var PropertyList_AVL = (from obj in Object3D_AVL select new NewAge_AVL_Property(obj.ObjLineRef, updateMethods, ((NewAge_AVL_NodeGroup)obj.Parent).PropertyMethods, true));
            ...
            var PropertyList_CAM = (from obj in Object3D_CAM select new NewAge_CAM_Property(obj.ObjLineRef, updateMethods, ((NewAge_CAM_NodeGroup)obj.Parent).PropertyMethods, true));
            var PropertyList_CAM_ZONE = (from obj in Object3D_CAM_ZONE select new NewAge_CAM_Zone_Property(obj.ObjLineRef, updateMethods, ((NewAge_CAM_Zone_NodeGroup)obj.Parent).PropertyMethods, true));
            var PropertyList_RTP = (from obj in Object3D_RTP select new NewAge_RTP_Property(obj.ObjLineRef, updateMethods, ((NewAge_RTP_NodeGroup)obj.Parent).PropertyMethods, true));
            ...
            All_List.AddRange(PropertyList_AVL);
            ...
            All_List.AddRange(PropertyList_CAM);
            All_List.AddRange(PropertyList_CAM_ZONE);
            All_List.AddRange(PropertyList_RTP);
            ...
            if (PropertyList_CAM.Count() > 0)
            {
                NewAge_CAM_Property p = new NewAge_CAM_Property(PropertyList_CAM.First());
                var prop = p.GetProperties();
                PopulateMultiSelectObjsList(prop);
            }

            if (PropertyList_CAM_ZONE.Count() > 0)
            {
                NewAge_CAM_Zone_Property p = new NewAge_CAM_Zone_Property(PropertyList_CAM_ZONE.First());
                var prop = p.GetProperties();
                PopulateMultiSelectObjsList(prop);
            }

            if (PropertyList_RTP.Count() > 0)
            {
                NewAge_RTP_Property p = new NewAge_RTP_Property(PropertyList_RTP.First());
                var prop = p.GetProperties();
                PopulateMultiSelectObjsList(prop);
            }
