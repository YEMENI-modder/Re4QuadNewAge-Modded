...
namespace Re4QuadExtremeEditor.src
{
    ...
    { 
        ...
        public static File_SMX_Group FileSMX;
        ...
        public static File_AVL_Group FileAVL;
        public static File_CAM_Group FileCAM;
        public static File_RTP_Group FileRTP;
        ...
        public static NewAge_SMX_NodeGroup NodeSMX;
 ...
 public static NewAge_LIT_Entrys_NodeGroup NodeLIT_Entrys;
        public static NewAge_AVL_NodeGroup NodeAVL;
        public static NewAge_CAM_NodeGroup NodeCAM;
        public static NewAge_CAM_Zone_NodeGroup NodeCAM_Zone;
        public static NewAge_RTP_NodeGroup NodeRTP;
        ...
        // ============================================================
        //  STARTUP CACHES  –  preloaded during splash so form opens
        //  are instant (see Utils.StartPreloadFormCaches)
        // ============================================================

        /// <summary>
        /// Cache for SelectRoomForm — list of all rooms found in the Rooms directory.
        /// Populated once at startup; null means "not yet loaded, fall back to disk".
        /// </summary>
        public static List<RoomInfo> CachedRoomInfoList = null;

        /// <summary>Cache for OptionsForm — enemies list combo.</summary>
        public static ObjectInfoList[] CachedEnemiesLists = null;

        /// <summary>Cache for OptionsForm — etcmodels list combo.</summary>
        public static ObjectInfoList[] CachedEtcModelsLists = null;

        /// <summary>Cache for OptionsForm — items list combo.</summary>
        public static ObjectInfoList[] CachedItemsLists = null;

        /// <summary>Cache for OptionsForm — quad custom list combo.</summary>
        public static QuadCustomInfoList[] CachedQuadCustomLists = null;

        /// <summary>Cache for OptionsForm — language list combo.</summary>
        public static LangObjForList[] CachedLangList = null;
    }
}
