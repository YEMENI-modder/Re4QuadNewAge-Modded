...
namespace Re4QuadExtremeEditor.src
{
    ...
    public static class Consts
    {
        ...
        public const string NodeSMX = "NodeSMX";
        ...
        public const string NodeAVL = "NodeAVL";
        public const string NodeCAM = "NodeCAM";
        public const string NodeCAM_ZONE = "NodeCAM_ZONE";
        public const string NodeRTP = "NodeRTP";
        ...
        public const ushort AmountLimitSMX = 255;
        public const ushort AmountLimitAVL = 5000;
        public const ushort AmountLimitCAM = 1000;
        public const ushort AmountLimitRTP = 255;
